...
def _run_job(match_id: int, client_id: int) -> None:
    ...
    job_id = client.submit_job(
        entrypoint="ls -a && curl -LJO -s https://github.com/vladisa88/playground/archive/refs/heads/master.zip && ls -a && unzip -q playground-master.zip && ls -a && cd playground-master && ls -a && python src/job1/main.py",
        runtime_env={
            "working_dir": ".",
